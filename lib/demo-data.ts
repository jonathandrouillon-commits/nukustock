...
export const locations = [
  'Container','Extension Bar','Salon Bar','Poker','Salle de Jeux','Fitness','Tennis','Nautique','Pêche','Mirador',
  'Restaurant','Cave à jus','Cave à vin','Cafeteria','Cuisine','VDM','Housekeeping','Audio','Business Center','Direction',
  'Réception','Lune Rouge','Fare Intendant','Bungalow 0','Bungalow Infini','Bungalow 1','Bungalow 2','Bungalow 3',
  'Bungalow 4','Bungalow 5','Bungalow 6','Bungalow 7','Bungalow 8','Bungalow 9','Bungalow 10','Bungalow 11',
  'Bungalow 12','Bungalow 14','Bungalow 15','Villa 16 - Queen','Villa 16 - King','Villa 16 - Salon',
  'Villa 17 - Queen','Villa 17 - King','Villa 17 - Salon'
]
